...
capture = cv2.VideoCapture(r"C:\Users\ROSHAN\Documents\GitHub\Lane-Detection\Images\Videos\test2.mp4")
while(capture.isOpened()):
    ret, frame = capture.read()
    if ret == True:
        c1 = canny(frame)
        cropped_image = region_of_interest_masked(c1)
        lines = cv2.HoughLinesP(cropped_image, 2, np.pi/180, 100, np.array([]), minLineLength=40,maxLineGap=5)
